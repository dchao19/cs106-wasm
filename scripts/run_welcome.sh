...
#
# Use this script to run the welcome project in the examples directory
# This script should be run from the root cs106-wasm directory
#
# Usage: ./scripts/run_welcome.sh [--clean]

SHOULD_CLEAN=${1:-false}
PROJECT_DIR=$PWD/examples/welcome
BUILD_DIR=$PWD/build/welcome
...
echo "Starting the server. The project will be available at localhost:8000/welcome.html. Press Ctrl+C to exit."
